...
!function(o,e){Fancybox.bind("[data-fancybox]",{}),o(".openLightboxBtn").click(function(){(lightbox=o("#"+o(this).attr("data-lightbox-id")))[0].style.display="flex",document.body.style.overflow="hidden"}),o(".closeLightboxBtn").click(function(){(lightbox=o("#"+o(this).attr("data-lightbox-id")))[0].style.display="none",document.body.style.overflow="auto"}),o("#menu").click(function(){o("body").addClass("push-menu-to-right"),o("#sidebar").addClass("open"),o(".overlay").addClass("show")}),o("#mask").click(function(){o("body").removeClass("push-menu-to-right"),o("#sidebar").removeClass("open"),o(".overlay").removeClass("show")}),o(e).scroll(function(){0<o(this).scrollTop()?o("body").addClass("light"):o("body").removeClass("light")});var a=o(".modal .close"),s=(a.on("click",function(){a.parent().parent().addClass("closed")}),o(".modal.exit")),t=(s.length&&ouibounce(s[0],{aggressive:!0,callback:function(){s.find(".close").on("click",function(){s.hide()})}}),{close:o(".icon-remove-sign"),searchform:o(".search-form"),canvas:o("body"),dothis:o(".dosearch")});function l(){o(".search-wrapper").toggleClass("active"),t.searchform.toggleClass("active"),t.canvas.removeClass("search-overlay")}t.dothis.on("click",function(){o(".search-wrapper").toggleClass("active"),t.searchform.toggleClass("active"),t.searchform.find("input").focus(),t.canvas.toggleClass("search-overlay"),o(".search-field").simpleJekyllSearch()}),t.close.on("click",l),document.addEventListener("keyup",function(e){27==e.keyCode&&o(".search-overlay").length&&l()}),1<=document.getElementsByClassName("home").length&&new AnimOnScroll(document.getElementById("grid"),{minDuration:.4,maxDuration:.7,viewportFactor:.2}),smoothScroll.init({selectorHeader:".bar-header",speed:500,updateURL:!1})}(Zepto,window);

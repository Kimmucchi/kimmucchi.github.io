...
!function(e,s){Fancybox.bind("[data-fancybox]",{}),e(".openLightboxBtn").click(function(){(lightbox=e("#"+e(this).attr("data-lightbox-id")))[0].style.display="flex",document.body.style.overflow="hidden",s.scroll({top:0,behavior:"smooth"})}),e(".closeLightboxBtn").click(function(){(lightbox=e("#"+e(this).attr("data-lightbox-id")))[0].style.display="none",document.body.style.overflow="auto"}),e("#scrollDown").click(function(){var o=document.getElementById("grid");o&&(o=o.offsetTop+-100,s.scroll({top:o,behavior:"smooth"}))}),e("#menu").click(function(){e("body").addClass("push-menu-to-right"),e("#sidebar").addClass("open"),e(".overlay").addClass("show")}),e("#mask").click(function(){e("body").removeClass("push-menu-to-right"),e("#sidebar").removeClass("open"),e(".overlay").removeClass("show")}),e(s).scroll(function(){0<e(this).scrollTop()?e("body").addClass("light"):e("body").removeClass("light")});var o=e(".modal .close"),a=(o.on("click",function(){o.parent().parent().addClass("closed")}),e(".modal.exit")),t=(a.length&&ouibounce(a[0],{aggressive:!0,callback:function(){a.find(".close").on("click",function(){a.hide()})}}),{close:e(".icon-remove-sign"),searchform:e(".search-form"),canvas:e("body"),dothis:e(".dosearch")});function l(){e(".search-wrapper").toggleClass("active"),t.searchform.toggleClass("active"),t.canvas.removeClass("search-overlay")}t.dothis.on("click",function(){e(".search-wrapper").toggleClass("active"),t.searchform.toggleClass("active"),t.searchform.find("input").focus(),t.canvas.toggleClass("search-overlay"),e(".search-field").simpleJekyllSearch()}),t.close.on("click",l),document.addEventListener("keyup",function(o){27==o.keyCode&&e(".search-overlay").length&&l()}),1<=document.getElementsByClassName("home").length&&new AnimOnScroll(document.getElementById("grid"),{minDuration:.4,maxDuration:.7,viewportFactor:.2}),smoothScroll.init({selectorHeader:".bar-header",speed:500,updateURL:!1})}(Zepto,window);
